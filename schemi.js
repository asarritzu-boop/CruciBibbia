const SCHEMI_BIBLICI = [
    ...
    },
    {
        ...
        parole: [
            ...
            { n: 3, d: 'V', x: 5, y: 0, w: 'ILCHIA', c: 'Sommo sacerdote che trovò il libro della Legge (2 Re 22:8)' },
    ...
    },
    {
        ...
        parole: [
            ...
            { n: 5, d: 'H', x: 0, y: 2, w: 'IAIRO', c: 'Presidente della sinagoga la cui figlia fu risuscitata (Marco 5:22)' },
            ...
            { n: 17, d: 'H', x: 7, y: 8, w: 'EDOM', c: 'Regione montuosa abitata dai discendenti di Esaù (Genesi 36:8)' },
    ...
    },
    {
        ...
        parole: [
            ...
            { n: 1, d: 'V', x: 0, y: 0, w: 'GOMORRA', c: 'Città citata come esempio di giudizio divino (Giuda 7)' },
    ...
    },
    {
        ...
        parole: [
            ...
            { n: 1, d: 'V', x: 0, y: 0, w: 'LICAONIA', c: 'Regione di Listra e Derbe visitata da Paolo (Atti 14:6)' },
    ...
    },
    {
        ...
        parole: [
            ...
            { n: 12, d: 'H', x: 5, y: 6, w: 'TIRSO', c: 'Vino nuovo che rallegra il cuore (Glossario)' },
            ...
            { n: 4, d: 'V', x: 8, y: 0, w: 'EBRAI', c: 'Scritture che compongono la prima parte della Bibbia' }
        ]
    },
    {
        id: 12,
    ...
    },
    {
        ...
        parole: [
            ...
            { n: 9, d: 'V', x: 3, y: 7, w: 'AL', c: '"In principio Dio creò il cielo e la terra" (Genesi 1:1)' }
        ]
    },
    {
        id: 14,
    ...
    },
    {
        ...
        parole: [
            ...
            { n: 13, d: 'H', x: 7, y: 6, w: 'EDOM', c: 'Nazione che discendeva da Esaù (Genesi 36:9)' },
