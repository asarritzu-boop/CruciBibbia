const SCHEMI_BIBLICI = [
    {
        ...
        parole: [
            ...
            { n: 1, d: 'V', x: 0, y: 0, w: 'TRAE', c: 'l'uomo buono ---- ciò che buono dal buon tesoro del suo cuore (Luca 6:45)' },
            { n: 2, d: 'V', x: 1, y: 0, w: 'ARDENTE', c: 'Può esserlo l'ira o un desiderio (Sofonia 2:2; 1Â Pietro 2:2)' },
            { n: 3, d: 'V', x: 3, y: 0, w: 'SCRIBI', c: 'Gesù li definì ipocriti (Matteo 23:13)' },
            { n: 4, d: 'H', x: 5, y: 0, w: 'LANCE', c: 'Saranno trasformate in cesoie (Isaia 2:4)' },
            { n: 4, d: 'V', x: 5, y: 0, w: 'LAMEC', c: 'Il padre di Noè (1 Cronache 1:3, 4)' },
            ...
            { n: 20, d: 'V', x: 0, y: 5, w: 'ASDOD', c: 'Importante città  filistea in cui cadde un tempio di Dagon (1Â Samuele 5:1-5)' },
            { n: 22, d: 'H', x: 4, y: 6, w: 'LIEVITO', c: 'Quello dei farisei e dei sadducei andava evitato (Matteo 16:11, 12)' },
            { n: 23, d: 'H', x: 2, y: 7, w: 'RUT', c: 'Bisnonna del re Davide (Matteo 1:5, 6)' },
            ...
            { n: 28, d: 'H', x: 0, y: 9, w: 'DEMA', c: 'Abbandonò Paolo per amore del presente sistema di cose (2 Timoteo 4:10)' },
    ...
    },
    {
        ...
        parole: [
            ...
            { n: 16, d: 'V', x: 10, y: 4, w: 'IO', c: 'Perchè...possa rispondere (Per 27:11)' },
